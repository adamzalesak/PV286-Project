...
public class HexToArrayConvertor : Convertor
{
    ...
    public HexToArrayConvertor(ConvertorOptions convertorOptions, IByteValidator byteValidator) : base(convertorOptions, byteValidator)
    {
    }
